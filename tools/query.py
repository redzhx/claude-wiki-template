#!/usr/bin/env python3
"""
# REFERENCE IMPLEMENTATION — This file is tightly coupled to the specific
# wiki schema, card types, and page format of the originating project.
# You MUST customize it for your own wiki before use. See docs/CUSTOMIZATION.md

Query the Cognitive Atlas.
...
def query(question: str, save_path: str | None = None):
    ...
    prompt = f"""You are querying an Cognitive Atlas to answer a question. Use the wiki pages below to synthesize a thorough answer. Cite sources using [[PageName]] wikilink syntax.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Query the Cognitive Atlas")
