...
Ingest a source document into the Cognitive Atlas.
...
def ingest(source_path: str, auto_convert: bool = True):
    ...
    prompt = f"""You are maintaining an Cognitive Atlas. Process this source document and integrate its knowledge into the wiki.
